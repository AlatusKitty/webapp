...
#   filename = "output.txt"
#   content  = <<EOF
#   HOST_NAME: ${aws_db_instance.db.endpoint}
#   USER_NAME: ${aws_db_instance.db.username}
...
# 在这个示例中，我们创建了一个名为EC2-CSYE6225的IAM角色，
...
#   name_prefix = "allow-s3"

#   ingress {
#     description = "Allow S3 inbound traffic"
#     from_port   = 0
#     to_port     = 65535
#     protocol    = "tcp"
#     cidr_blocks = ["0.0.0.0/0"]
